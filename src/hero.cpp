...
// 							cout <<movement_stack.size()<<endl;
                            lastPosition.x=line_stack.front().x;
                            lastPosition.y=line_stack.front().y;
